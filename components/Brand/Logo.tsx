export default function Brand() {
  return (
    <a className="flex items-center gap-2" href="/">
        ...
        <g clipPath="url(#clip0_84_15696)">
          ...
          <g clipPath="url(#clip1_84_15696)">
            <path
              fill="#2c9cc4"
              fillOpacity=".4"
              d="M85.0011 280.852L85.8544 152.874C86.0038 129.706 102.206 109.844 124.574 105.418L248.169 80.9163C277.865 75.0283 305.428 98.2709 305.236 129.023L304.382 257.023C304.222 280.18 288.02 300.031 265.652 304.468L142.057 328.97C112.361 334.858 84.7984 311.615 85.0011 280.852Z"
            ></path>
            <path
              fill="#2c9cc4"
              fillOpacity=".6"
      ...
      <span className=" font-semibold text-lg">imagetoprompt</span>
    </a>
  );
}
